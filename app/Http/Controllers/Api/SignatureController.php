...
@media print {
  body, page {
    box-shadow: 0;
	padding:0.8cm 1.0cm 0.8cm 0.2cm;
	font-size:12px;
  ...
  @media screen {
         page[size="A4"] {padding:1.5cm; font-size:12px;}
                                        ...
                                        <div class="header-right">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="cert-body">
                                                    ...
                                                    <p> <b>Statutory {{DOCUMENT TYPE}} No {{DOCUMENT ID}}</b>    <span>Page: 45</span>     <span>Volume: 45</span></p>
                                                    <p> THIS IS TO CERTIFY THAT <b>{{FIRST NAME}} {{MIDDLE NAME}} {{LAST NAME}}</b> hereinafter called the holder/holders which term shall include any person/persons defined as such in section 9 of the Land Use Act    No.6 of 1978) is/are entitled to a right of occupancy in and over 
                                                    Plot <b>{{STREET ADDRESS}}</b> in Block within <b>{{DIMENSION AREA (SQM)}}</b> Layout or in and over a parcel of land described in the schedule and more particularly delineated in the 
                                                    </p>

                                                    <p> Plan No <b>{{SURVEY PLAN NUMBER}}</b> annexed hereto for a term <b>{{TERM}}</b> years commencing from the 1st day of January, 2018  according to the true intent and meaning of the Land Use Act of No.6 of 1978 and subject to the provision thereof and to the following special terms and conditions hereinafter contained. 
                                                        </p>

                                                   
                                                    <ol>
                                                        <li>To pay in advance without demand to the Governor or other person appointed by him yearly rent of <b>{{YEARLY RENT PAYABLE}}</b> on the first day of January in each year.</li>

                                                        <li>The rent hereby reserved hall be revised at the end of every ten years of the <b>{{DOCUMENT TYPE}}</b></li>
                                                        ...
                                                        <li>To erect and complete on the said land within <b>{{DEVELOPMENT PERIOD}}</b> years from the date of ncement of this right of occupancy, buildings or other work specified in the etailed plans approved by the Chief Land Officer or other officer appointed by the Governor in that behalf.</li>
                                                        ...
                                                        <li> To use the said land only for <b>{{PURPOSE OF USE}}</b> Purpose </li>
                                                    ...
                                                    <div class="cert-footer">
                                                        ...
                                                        <div class="cert-left">
                                                            <h2>Date</h2>
                                                            <p><span class="cert-date"> {{date}} </span></p>
                                                        </div>
